...
import com.g4stly.springboot.restApi.jpa.PostRepository;
import com.g4stly.springboot.restApi.jpa.UserRepository;
...
public class UserJpaResource {
	...
	public ResponseEntity<List<Post>> createPost(@PathVariable int id, @Valid @RequestBody Post post) {
		Optional<User> user = userRepository.findById(id);
		if(user.isEmpty()) {
			throw new UserNotFoundException("id: "+id);
		}
